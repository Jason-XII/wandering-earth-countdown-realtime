...
tc_font = ImageFont.truetype('zh-cn.ttf',160)
te_font = ImageFont.truetype('zh-cn.ttf',72)
n_font = ImageFont.truetype('en-nu.ttf',375)
...
timetype_translate = {'秒':'SECONDS','分钟':'MINUTES','小时':'HOURS',
                                ...
                                '时':'HOURS', '节课':'LESSONS',}
timeleft = 88
def genimg(text, timetype_cn, timeleft, outpath='out.png', show=False):
    # 处理文本和文字间隔
    if(timeleft == 1):
    ...
    pen.text((size_e[2]+size_2[2]+10,-80),str(timeleft),font=n_font,fill='red') #***
